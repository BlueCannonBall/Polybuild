...
int main() {
    ...
    std::ofstream script("polybuild.sh");
    script << "#!/bin/bash\n";
    script << "# This file was auto-generated by Polybuild\n";
    ...
    script.close();
#ifndef _WIN32
    chmod("polybuild.sh", 0755);
#endif
    std::cout << log("Finished producing polybuild.sh!") << std::endl;
